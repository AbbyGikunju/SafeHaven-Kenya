...
function startStatsAnimation(entries, observer) {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            animateCounter('total-incidents', 520);
            animateCounter('urban-cases', 320);
            animateCounter('rural-cases', 200);
            animateCounter('conviction-rate', 15); // Conviction Rate will show percentage
